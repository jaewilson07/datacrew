...
linked_kbs :  ['https://domo-support.domo.com/s/article/360042931494', 'https://domo-support.domo.com/s/article/360042925494', 'https://domo-support.domo.com/s/knowledge-base', 'https://domo-support.domo.com/s/article/360043429953', 'https://domo-support.domo.com/s/article/360042926054', 'https://domo-support.domo.com/s/article/360043429933', 'https://domo-support.domo.com/s/article/360043429693', 'https://domo-support.domo.com/s/topic/0TO5w000000ZamwGAC', 'https://domo-support.domo.com/s/article/360043429913']
...
This section explains how to set up a JSON WebhookÂ connection in Domo and in the third-party application.Â Once you have set up a successful connection, you can use the same account any time you go to create a new JSON Webhook DataSet. You can manage connector accounts in the **Accounts** tab in the Data Center. For more information about this tab, see [Managing User Accounts for Connectors](..\managing_user_accounts_for_connectors\index.html "Managing User Accounts for Connectors").


**To set up a JSON Webhook connection,**


1. Select **Appstore** from the top navigation pane.Â
2. Search for "JSONÂ Webhook," then click the tile when it appears.
3. ClickÂ **Get the Data**.
4. ClickÂ **Copy Link**.
5. Paste the linkÂ you just copied into the appropriate location in your third-party application.  
  
The following screenshot comes from Github:  
  
![json_webhook_3rd_party_url.png](json_webhook_3rd_party_url.png)  
  
This location willÂ *usually*Â be a field with a name like "Payload URL," like in the above screenshot.Â However, there are exceptions. Please refer to the third-party application's documentation if you are not sure.Â   
...
9. (Optional) Enter a **WebhookÂ Secret**Â if desired.Â   
...
10. (Optional) If you want to include metadata in the DataSet, such as IP and timestamp, selectÂ **Yes**Â in the last menu in theÂ **DetailsÂ**view; otherwise leave this set toÂ **No**.
11. (Optional) If you want to use "Replace" instead of "Append" when the DataSet is updated, clickÂ **Change update settings**, selectÂ **Replace**Â in the menu, then clickÂ **Save**.
12. ClickÂ **Next**.
13. Enter a DataSet name and description (optional) in the correct fields.Â
14. ClickÂ **Save**.
