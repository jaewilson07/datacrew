...
linked_kbs :  ['https://domo-support.domo.com/s/article/360042925494', 'https://domo-support.domo.com/s/knowledge-base', 'https://domo-support.domo.com/s/article/360043429953', 'https://domo-support.domo.com/s/article/360043438973', 'https://domo-support.domo.com/s/article/360043429933', 'https://domo-support.domo.com/s/article/360043429693', 'https://domo-support.domo.com/s/topic/0TO5w000000ZamwGAC', 'https://domo-support.domo.com/s/article/360046074774', 'https://domo-support.domo.com/s/article/360043429913']
...
To get started, choose the **Open With**Â dropdown and select **Views Explorer**. This will take you to a new window where you will be able to explore your data.
...
Removing columns is a common step in cleansing data, and Views Explorer makes it easy to remove columns from your DataSet. Columns can be removed by selecting the triple dot menu on each column and selecting **Delete**. To remove multiple columns, you can also choose the **Select All**Â option from the columns on the left and the delete icon.


  
![Copy_Picture3.png](Copy_Picture3.png) Â  Â  Â  ![Picture2.png](Picture2.png)
...
Reordering columns can be done in two places. To move a column select the **Move**Â option in the triple dot menu and selecting one of the four options: **Left**, **Right**, **First**,Â or **Last**. You may also drag and reorder columns by using the columns on the left.


![Picture7.png](Picture7.png) Â  ![Picture6.png](Picture6.png)
...
![Picture8.png](Picture8.png) Â  ![Picture9.png](Picture9.png)
...
From the Select ColumnsÂ modal choose which columns you would like to include in your DataSet and select **Save**. The columns you selected will now appear in your DataSet.
...
![Picture15.png](Picture15.png) Â  ![Picture14.png](Picture14.png)


### Group Data


Grouping data helps you to see only columns you are interested in and aggregations to summarize the data from the categories you have selected.Â To Group data, start by selecting the **Group**Â button.
...
![Picture20.png](Picture20.png) Â  ![Picture21.png](Picture21.png)
...
![Picture22.png](Picture22.png) Â  ![Picture23.png](Picture23.png)
...
When you have finished your exploration, you may want to save it as a new DataSet View. To save your Views exploration as a new DataSet View choose the **Save As**Â Button. Choose a new name for your View and then Select **Save**.


![Picture25.png](Picture25.png) Â  ![Picture26.png](Picture26.png)


Your DataSet View will appear in Domo as a new DataSet that can be shared with others in Domo. PDP policies from the parent DataSet will still applyÂ and the DataSet View will update when the parent DataSet updates.
...
No, at this time Views are not supported inside of MySQL DataFlows.Â