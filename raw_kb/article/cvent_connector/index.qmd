...
Before you connect to Cvent in Domo, you should whitelistÂ the following IP addresses to your Cvent account:
...
This section enumerates the options in the **Credentials** and **Details** panes in the Cvent Connector page.Â The components of the other panes in this page, **Scheduling**Â and **Name & Describe Your DataSet**, are universal across most connector types and are discussed in greater length inÂ [Adding a DataSet Using a Data Connector](..\adding_a_dataset_using_a_connector\index.md "Adding a DataSet Using a Data Connector").


### Credentials Pane


This pane contains fields for entering credentials to connect to your Cvent account. The following table describes what is needed for each field: Â 
...
| Menu | Description |
| --- | --- |
| Report | Select the Cvent report you want to run.Â The following reports are available:
...
| Event | Â Returns a list of events for the authenticated user's account. |
