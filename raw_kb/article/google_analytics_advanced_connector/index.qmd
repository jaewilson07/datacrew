...
linked_kbs :  ['https://domo-support.domo.com/s/article/360042926274', 'https://domo-support.domo.com/s/knowledge-base', 'https://domo-support.domo.com/s/article/360042925494', 'https://domo-support.domo.com/s/article/360043429953', 'https://domo-support.domo.com/s/article/360042929254', 'https://domo-support.domo.com/s/article/360042926054', 'https://domo-support.domo.com/s/article/360043429933', 'https://domo-support.domo.com/s/article/360042933674', 'https://domo-support.domo.com/s/article/360043429693', 'https://domo-support.domo.com/s/topic/0TO5w000000ZamwGAC', 'https://domo-support.domo.com/s/article/360043429913']
...
* When starting out, consider deploying the [Google Analytics Dashboard](..\google_analytics_dashboard_app\index.html "Google Analytics QuickStart App"). The Base Metrics report has many of the fundamental metrics that are key to a Google Analytics Dashboard.
...
This section enumerates the options in theÂ CredentialsÂ andÂ DetailsÂ panes in the Google Connector page.Â The components of the other panes in this page,Â **SchedulingÂ**andÂ **Name & Describe Your DataSet,** are universal across most connector types and are discussed in greater length in [Adding a DataSet Using a Data Connector](..\adding_a_dataset_using_a_connector\index.md "Adding a DataSet Using a Data Connector").


### Credentials Pane


The Domo Google Analytics Advanced connector uses OAuth to connect, so there is no need to enter credentials within Domo. ClickÂ **Connect**Â (or selectÂ **Add Account**Â ifÂ you haveÂ existing Google accounts in Domo) to open the Google OAuth screen where you can enter your Google email address and password. Once you have entered valid Google credentials, you can use the same account any time you go to create a new Google Analytics Advanced DataSet. You can manage connector accounts in theÂ **Accounts**Â tab in theÂ Data Center. For more information about this tab, seeÂ [Managing User Accounts for Connectors](..\managing_user_accounts_for_connectors\index.html "Managing User Accounts for Connectors").
...
This pane contains a number of subpanesÂ in which you can select a report, set a date range, choose your segments, and more.
...
| Subpane | Description |
| --- | --- |
| View | Choose whether you want to pull data from a specific view or all views. If you chooseÂ ********Specific views********, you are asked to choose the desired profiles. Be aware that you won't be able to use custom metrics and dimensions if you choose more than one web property. |
| Report | The Google Analytics reports are dividedÂ  into three categories, namely-Â Custom report, Google Analytics Audience reports, and Curated Domo reports. The number of available Metrics and Dimensions for the selected reportÂ appearÂ next to the reports drop down. You can view the names of the metrics and dimensions as you hover the pointer over the respective field. The following reports are available:

|  |  |
| --- | --- |
| Custom Report | CustomÂ Report allows you to create a customized report. You can select a baseÂ report for your custom report from theÂ ****Base Report****Â drop down.Â Depending on your base report selection, the number of metrics and dimensions that you can combine in your custom report appear next to the report drop down as well as in the left pane. You can select the categories from list available. A list of available metrics and dimensions for the selected category appears in the right pane. As you select/deselect the desiredÂ metrics and dimensions, you can see the changes in the respective numbers in the left pane as well as next to the report drop down.Â  |
| ****Google Analytics Audience reports**** |
| Active Users | Returns data for Users,Â NewÂ Users, andÂ Sessions. |
...
For example, you mightÂ choose to pull in data for a date range and then opt to have relative start and end dates for the range. If you were to select 14 days back for the start date and 7Â days back for the end date, every time the report ran it would pull data for the last 14 days up until the last 7 days.Â  |
| Segments | Select whether you want to use Segments in your data.Â A Segment is a subset of GoogleÂ Analytics data. For example, of the entire set of users, one Segment might be users from a particular country or city. Segments let you isolate and analyze those subsets of data so you can examine and respond to the component trends in your business.
You can build dynamic Segments within Domo. You do this by inputting JSONÂ code formatted as follows:
`[Â  Â  {Â  Â  Â  Â  "dynamicSegment": {Â  Â  Â  Â  Â  Â  "name": "Sessions with Safari browser",Â  Â  Â  Â  Â  Â  "userSegment": {Â  Â  Â  Â  Â  Â  Â  Â  "segmentFilters": [Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  {Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  "simpleSegment": {Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  "orFiltersForSegment": [Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  {Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  "segmentFilterClauses": [Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  {Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  "dimensionFilter": {Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  "dimensionName": "ga:browser",Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  "operator": "EXACT",Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  "expressions": [Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  "Safari"Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  ]Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  }Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  }Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  ]Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  }Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  ]Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  }Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  }Â  Â  Â  Â  Â  Â  Â  Â  ]Â  Â  Â  Â  Â  Â  }Â  Â  Â  Â  }Â  Â  }]`
For more detailed information about building segments, seeÂ [https://developers.google.com/analyt...asics#segments](https://developers.google.com/analytics/devguides/reporting/core/v4/basics#segments "https://developers.google.com/analytics/devguides/reporting/core/v4/basics#segments").Â  |
| Filters | Select whether you want to use Filters in your data.Â Filters can be used to collect only data that matches specific criteria. You can filter specific metrics or dimensions. For example, you could limit the "browser"Â dimension to show only traffic from the Safari or Chrome browsers.
For more information about utilizing Google Analytics filters, seeÂ [https://developers.google.com/analyt...erence#filters](https://developers.google.com/analytics/devguides/reporting/core/v3/reference#filters "https://developers.google.com/analytics/devguides/reporting/core/v3/reference#filters").
You can build Dimension FiltersÂ and Metrics Filters within Domo. You do thisÂ by inputting JSONÂ code formatted as follows:
`{Â  Â  "metricFilterClauses": [Â  Â  Â  Â  {Â  Â  Â  Â  Â  Â  "filters": [Â  Â  Â  Â  Â  Â  Â  Â  {Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  "metricName": "ga:pageviews",Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  "operator": "GREATER_THAN",Â  Â  Â  Â  Â  Â  Â  Â  Â  Â  "comparisonValue": "2"Â  Â  Â  Â  Â  Â  Â  Â  }Â  Â  Â  Â  Â  Â  ]Â  Â  Â  Â  }Â  Â  ]}`
For more detailed information about building Filters, seeÂ [https://developers.google.com/analyt...sics#filtering](https://developers.google.com/analytics/devguides/reporting/core/v4/basics#filtering "https://developers.google.com/analytics/devguides/reporting/core/v4/basics#filtering").Â  |
...
| Test | ClickÂ ********Run Test********Â to test your configuration. |


### Other Panes


For information about the remaining sections of the connector interface, including how to configure scheduling, retry, and update options, seeÂ [Adding a DataSet Using a Data Connector](..\adding_a_dataset_using_a_connector\index.md "Adding a DataSet Using a Data Connector").
