---
title : Old Magic ETL Tiles: Rank and Window
categories: ['https://domo-support.domo.com/s/topic/0TO5w000000ZamwGAC']
date: 2022-10-24 22:41:00
url : https://domo-support.domo.com/s/article/360042922814
linked_kbs :  ['https://domo-support.domo.com/s/article/360042925494', 'https://domo-support.domo.com/s/knowledge-base', 'https://domo-support.domo.com/s/article/360043429953', 'https://domo-support.domo.com/s/article/360043429933', 'https://domo-support.domo.com/s/article/360042922814', 'https://domo-support.domo.com/s/article/360043429693', 'https://domo-support.domo.com/s/topic/0TO5w000000ZamwGAC', 'https://domo-support.domo.com/s/article/360043429913']
article_id : 000002993
views : 11,894
...
**Note:** This article is for the old Magic ETL. For information on the new Magic ETL, see [New Magic ETL](..\..\category\magic_etl\index.md).
...
1. Click the **Rank & Window** action in the canvas.
2. (Optional) Rename the action by clicking ![de_edit__1_.png](de_edit__1_.png), then entering the name you want.
...
9. (Optional) In Step 4 of the dialog, select the column to use as a partition, if any. (For an explanation of partitioning, see [Understanding partitions](#h_01F0MDK9T013ZZBRV63XCSJMYV "ETL Actions: Rank and Window")Â at the top of this page.)
...
![rank_and_window_row_numbers.png](rank_and_window_row_numbers.png)Â 
...
For an explanation of partitioning, see [Understanding partitions](#h_01F0MDK9T013ZZBRV63XCSJMYV "ETL Actions: Rank and Window")Â at the top of this page.
...
11. (Optional) In Step 4 of the dialog, select the column to use as a partition, if any. (For an explanation of partitioning, see [Understanding partitions](#h_01F0MDK9T013ZZBRV63XCSJMYV "ETL Actions: Rank and Window")Â at the top of this page.)
...
9. In Step 2 of the dialog, select the column you want your order to be based on.
10. In Step 3 of the dialog, select the order you want the values in the new column to be sorted in.
11. (Optional) In Step 4 of the dialog, select the column to use as a partition, if any.Â (For an explanation of partitioning, see [Understanding partitions](#h_01F0MDK9T013ZZBRV63XCSJMYV "ETL Actions: Rank and Window")Â at the top of this page.)