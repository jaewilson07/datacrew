...
linked_kbs :  ['https://domo-support.domo.com/s/article/360042925494', 'https://domo-support.domo.com/s/knowledge-base', 'https://domo-support.domo.com/s/article/360043429953', 'https://domo-support.domo.com/s/article/360042933134', 'https://domo-support.domo.com/s/article/360043429933', 'https://domo-support.domo.com/s/article/360043429693', 'https://domo-support.domo.com/s/topic/0TO5w000000ZamwGAC', 'https://domo-support.domo.com/s/article/360042933114', 'https://domo-support.domo.com/s/article/360043429913']
...
The operandsÂ you can use when writing code with Pfilters are as follows. Note that the values always need square brackets for the array, even when only a single value is included.Â Â 
...
Domo automatically creates Pfilters when you checkÂ **Persist Filters**Â in the embed dialog, as shown here:  
Â 
...
You can then viewÂ the parameters by hovering over the content.Â (Card interactionsÂ must be turned on and set to **External link**Â for this to work). This is shown for the "QA pass rate by model" Card in the following example:  
Â 
...
![domo_everywhere_pfilters_4.png](domo_everywhere_pfilters_4.png)Â  Â  Â Â   
**Â**
...
If you wantÂ Pfilters to expand beyond pages to also persist across sessions and refreshes, you'll need to store and load the last known state of the Pfilters.Â 
...
If aÂ Pfilter is written incorrectly, the unfiltered version renders and a black error bar appears.
