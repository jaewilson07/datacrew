...
linked_kbs :  ['https://domo-support.domo.com/s/article/360042925494', 'https://domo-support.domo.com/s/knowledge-base', 'https://domo-support.domo.com/s/article/360043429953', 'https://domo-support.domo.com/s/article/360043433813', 'https://domo-support.domo.com/s/article/4492108625687', 'https://domo-support.domo.com/s/article/360043437893', 'https://domo-support.domo.com/s/article/4571739374487', 'https://domo-support.domo.com/s/article/4529058568855', 'https://domo-support.domo.com/s/article/4403508913943', 'https://domo-support.domo.com/s/article/4533903600407', 'https://domo-support.domo.com/s/article/4546361976087', 'https://domo-support.domo.com/s/article/360043430233', 'https://domo-support.domo.com/s/article/4529227357975', 'https://domo-support.domo.com/s/article/360043429693', 'https://domo-support.domo.com/s/article/4546335931031', 'https://domo-support.domo.com/s/article/4412849158167', 'https://domo-support.domo.com/s/article/360042922874', 'https://domo-support.domo.com/s/article/360043429933', 'https://domo-support.domo.com/s/topic/0TO5w000000ZamwGAC', 'https://domo-support.domo.com/s/article/360043429913', 'https://domo-support.domo.com/s/article/4530782510871', 'https://domo-support.domo.com/s/article/1500010172542', 'https://domo-support.domo.com/s/article/4546378883863', 'https://domo-support.domo.com/s/article/4423762260375', 'https://domo-support.domo.com/s/article/7579340458903']
...
For more information, see [DomoStats Connector](..\domostats_connector\index.md).
...
For more information, see [Adding a Notebook Card](..\adding_a_notebook_card\index.md).
...
For more information, see [Using Smart Text](..\using_smart_text\index.md).
...
For more information, see [Page Filters in Dashboard Embed](..\page_filters_in_dashboard_embed\index.md).
...
For more information, see [Exporting Embedded Content](..\exporting_embedded_content\index.md).
...
For more information, see [DDX Bricks](..\domo_bricks\index.md).
...
For more information, see [Drag-and-Drop Apps](..\draganddrop_apps\index.md).
...
For more information, see [Exporting Dashboards to PDF or PowerPoint](..\exporting_dashboards_to_pdf_or_powerpoint\index.md).
...
For more information, see [Edit the Mobile Layout](..\editing_a_dashboards_mobile_layout\index.md).
...
For more information, see [Dropdown Selector Card](..\dropdown_selector_card\index.md).
...
For more information, see [Radial Progress Gauge](..\radial_progress_gauge\index.md).
...
For more information, see [Multi Radial Progress Gauge](..\multi_radial_progress_gauge\index.md).
...
For more information, see [Waffle Gauge](..\waffle_gauge\index.md).
...
**Note:**Â Depending on the feature, you may be required to complete training before you can use the feature.
...
For more information, see [Community-Built Connectors (Beta)](..\community_built_connectors\index.md).
...
* Increased stress on, and demands from, data teams. Business users demand access to data products in a timely manner, increasing pressure to deliver.â€‹
...
For more information, see [Multi-Cloud Data Fabric](..\cloud_amplifier_overview\index.md).
...
You can view the latest release notes information in the Help Center, which you can access from Domo by selecting the Help Center inÂ the top navigation bar.
...
If you have feedback, please send it from within Domo (**MoreÂ > Feedback**). Or send an email toÂ [product.feedback@domo.com](mailto:product.feedback@domo.com "product.feedback@domo.com").
