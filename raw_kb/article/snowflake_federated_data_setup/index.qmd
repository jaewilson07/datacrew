...
linked_kbs :  ['https://domo-support.domo.com/s/article/360042925494', 'https://domo-support.domo.com/s/knowledge-base', 'https://domo-support.domo.com/s/article/360043429953', 'https://domo-support.domo.com/s/article/360043429933', 'https://domo-support.domo.com/s/article/360043429693', 'https://domo-support.domo.com/s/topic/0TO5w000000ZamwGAC', 'https://domo-support.domo.com/s/article/360049429094', 'https://domo-support.domo.com/s/article/360043429913']
...
Domo has a new streamlined Federated connection setup experience for cloud native data warehouses, starting exclusively with Snowflake. You can directly setup a Snowflake connected account from Domoâ€™s Data Center experience and use that to create Federated DataSets from your Snowflake database tables.
...
1. Start with Domoâ€™s data warehouse platter visualization and click on the **+**Â **Add New Data Warehouse**Â button.  
  
![Warehouse_step_1.png](Warehouse_step_1.png)
2. Select **Snowflake** Driver and clickÂ **Next**.  
...
3. Enter your connection parameters specific to the Snowflake database you need to connect to. The following fields are required:
	...
	2. Host â€“ This is the Snowflake account name for your Snowflake account. Note that your full account name may include additional segments that identify the region and the cloud service provider where your Snowflake account is hosted e.g. [xyz1234.us](http://xyz1234.us)-east-1, xyz1234.west-europe.azure, etc. You need to provide your full hostname, e.g. *[yourcompany.snowflakecomputing.com](http://yourcompany.snowflakecomputing.com)*
	3. Warehouse â€“ Existing Snowflake warehouse you need want to use to send queries from Domo. We recommend setting a warehouse specific to Domo.
	4. Username â€“ Snowflake username you want to connect with. We recommend creating a new user in your Snowflake account specifically to service Federated queries from Domo.
	5. Password â€“ Password for your username.
	6. Role and Port are optional depending on your Snowflake account setup.  
	  
	![Warehouse_step_3.png](Warehouse_step_3.png)
4. You should have a Snowflake federate account created now. Common errors are typically due to incorrect connection parameters. Please contact SupportÂ for any help needed.  
...
On the preview pane on the right, you can also toggle between viewing a preview of the data or viewing the schema of the table being used. ClickÂ the **Create**Â button to complete your DomoÂ Federated DataSet creation.  
...
##### Does Domoâ€™s DataSet Views Explorer work on Snowflake Federated DataSets?


Yes, Domoâ€™s interactive, easy to use DataSet views feature can be used to explore Snowflake Federated DataSets. You can filter, group, limit, sort, and join DataSets, as well as create new calculated columns and save your transformation as new DataSet Views. These DataSet Views are virtual in Domo, and do not create Views in the customer Snowflake Data warehouse.


##### Can Domoâ€™s ETL and SQL tools be used to transform federated DataSets?


No, currently this isnâ€™t supported, but we would love to understand your use case. Please reach out via your CSM or AE to talk to Domoâ€™s product team.
