...
linked_kbs :  ['https://domo-support.domo.com/s/article/360043429693', 'https://domo-support.domo.com/s/article/360042926054', 'https://domo-support.domo.com/s/article/360043429933', 'https://domo-support.domo.com/s/article/360043438973', 'https://domo-support.domo.com/s/article/360042926274', 'https://domo-support.domo.com/s/article/360043429913', 'https://domo-support.domo.com/s/knowledge-base', 'https://domo-support.domo.com/s/article/360042925814', 'https://domo-support.domo.com/s/article/360042925494', 'https://domo-support.domo.com/s/article/360042934334', 'https://domo-support.domo.com/s/article/360043429953', 'https://domo-support.domo.com/s/article/360047553253', 'https://domo-support.domo.com/s/topic/0TO5w000000ZamwGAC', 'https://domo-support.domo.com/s/article/360042926074']
...
When the OAuth token for an account is about to expire, you receive notifications in Domo and via email/SMS. For information about setting notification preferences, see [Customizing Notification and Alert Settings](..\configuring_notification_and_alert_settings\index.qmd "Customizing Notification and Alert Settings").


If you delete a user from Domo and reassign his/her DataSets to another user, the permissions for the DataSet accounts *is not* passed to the new user. The account ownership must be transferred manually. For more information, see [Removing Users from Domo](..\removing_users_from_domo\index.qmd "Removing Users from Domo").


For more information about the layout of this tab, see [Data Center Layout](..\data_center_layout\index.qmd "Data Center Layout").
...
The Data Center opens, with the **DataSets** tab opened by default. 
...
* By adding a DataSet to Domo and entering new account information (as opposed to selecting an existing account). An entry for the new account appears automatically in the **Accounts** view. This method is discussed in more detail in [Adding a Dataset Using a Data Connector](..\adding_a_dataset_using_a_connector\index.qmd "Connecting to Data with Connectors").
...
2. Click ![](2.png) and select **Delete Account**.
...
2. Click ![](2.png) and select **Re-connect**.
...
5. Select the desired user and click **Add**. 


6. The newly added user will appear in the **Shared with** section. Repeat the same process to add multiple users you want to share the account with.
...
4. Click the cross (![Cross.png](Cross.png)) in front of the the user name that you want to remove the access for. 
...
**Tip:**You can change ownership of a single DataSet in the Details view for the DataSet. For more information, see [Changing the Owner of a DataSet](..\changing_the_owner_of_a_dataset\index.qmd "Changing the Owner of a DataSet").
...
**Tip:**You can change the connection account associated with a single DataSet in the Details view for the DataSet.
