...
url : https://domo-support.domo.com/s/article/360042929714
linked_kbs :  ['https://domo-support.domo.com/s/article/360042925494', 'https://domo-support.domo.com/s/article/360042929714', 'https://domo-support.domo.com/s/knowledge-base', 'https://domo-support.domo.com/s/article/360043429953', 'https://domo-support.domo.com/s/article/360043429933', 'https://domo-support.domo.com/s/article/360043429693', 'https://domo-support.domo.com/s/topic/0TO5w000000ZamwGAC', 'https://domo-support.domo.com/s/article/360043429913']
article_id : 000003479
views : 3,274
...
Â
**What is happening?**  
At Domo, we take pride in providing the industry leading,Â best time to value solution, with an eco-system of over 500 connectors. We regularly review our connector offerings and make enhancements to provide a more robust experience for our customers.  
  
Zoho recently announced that they will be deprecating their older API version 1.0 on December 31, 2018. Starting January 1, 2019, they will only be supporting API version 2.0. To account for this change we have updated the Zoho connector to API version 2.0 on October 30, 2018. The connector version is now 2.90, released on October 30th.Â   
  
**When is this change happening?**  
As Zoho indicated [here](index.html "Zoho CRM Connector"), API version 1.0 will be deprecated on December 31, 2018.  
  
**How does this impact me?**  
All reports running against API version 1.0 will no longer update after December 31, 2018.  
  
**What do I have to do?**  
To minimize disruption, make sure that you re-create all of your DataSets that were created before October 30th, 2018.Â
Â
Â
Intro
-----
...
You connect to your Zoho CRM account in the Data Center. This topic discusses the fields and menus that are specific to theÂ Zoho CRM connector user interface. General information for adding DataSets, setting update schedules, and editing DataSet information is discussed inÂ [Adding a DataSet Using a Data Connector](index.html "Adding a DataSet Using a Data Connector").
...
To connect to your Zoho CRM account and create a DataSet, you must have the client ID and client secret associated with your Zoho CRM account.Â Â 
...
Â
**Note**: Use the redirect URI as **<https://oauth.domo.com/api/data/v2/oauth/providers/zoho-crm-enterprise/exchange>**
Connecting to YourÂ Zoho CRMÂ Account
-------------------------------------


This section enumerates the options in theÂ **Credentials**Â andÂ **Details**Â panes in theÂ Zoho CRM Connector page.Â The components of the other panes in this page,Â **Scheduling**Â andÂ **Name & Describe Your DataSet**, are universal across most connector types and are discussed in greater length inÂ [Adding a DataSet Using a Data Connector](index.html "Adding a DataSet Using a Data Connector").
...
| Domain | Select your Zoho CRM domain. To find your domain, log intoÂ [Zoho CRM](https://accounts.zoho.com/signin)Â and observe the host address. **Example:**Â After logging in, if your host address is <https://abc.zoho.com.au/>, your domain would be AU. |


Once you have entered valid Zoho CRM credentials, you can use the same account any time you go to create a new Zoho CRM DataSet. You can manage connector accounts in the **Accounts**Â tab in theÂ **Data Center**. For more information about this tab, seeÂ [Managing User Accounts for Connectors](index.html "Managing User Accounts for Connectors").


### Details Pane


This pane contains a primary **Method**Â menu, in which you specify the data you want to retrieve. Depending on the selected method,Â various other menus may appear.
...
| **Menu** | **Description** |
| --- | --- |
| Method | Select theÂ Zoho CRM dataÂ you want to retrieve. The following methodsÂ are available:
...
| Users | Returns the list of users in your organization |
 ...
 |
| Module | Select the Zoho CRM module to pull data from.Â Â  |
...
| Past Days | Enter the number of days of data to retrieve. For example, enteringÂ 30Â would pull data for the last 30 days. |
| Search Condition | Enter the search statement to pull data for.

|  |  |  |
| --- | --- | --- |
|  | **Format** | **Example** |
| Email | [username@domain.com](mailto:username@domain.com) | [daly@zylker.com](mailto:daly@zylker.com) |
| Phone | xxx-xxx-xxxx | 888-555-2145 |
| Word | Search Word | test |
| Criteria | (({apiname}:{starts\_with|equals}:{value}) and ({apiname}:{starts\_with|equals}:{value})) | (Last\_Name:equals:Boyle) for Lead ModuleÂ 
will search the Last\_Name column for rows equaling Boyle |

SeeÂ [Zoho API Help Link](https://www.zoho.com/crm/help/api/v2/#ra-search-records) for more help. |
...
For information about the remaining sections of the connector interface, including how to configure scheduling, retry, and update options, seeÂ [Adding a DataSet Using a Data Connector](index.html "Adding a DataSet Using a Data Connector").
