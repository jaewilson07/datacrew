...
**Note:Â**Workbench 5.1 determines at runtime whether you are using a 32- or 64-bit version of Windows; thus you are not asked to specify a version.Â
Â 
...
19. (Optional)Â Define replacement variables for columns in the DataSet in theÂ **Replacement Variables**Â and **Global Replacement VariablesÂ**tabs.Â For each replacement variable...
	...
	**Note:Â**The **Column** name is case sensitive and must match the column name found in theÂ [**Schema Subtab**](..\understanding_the_workbench_51_user_interface\index.html "Understanding the Workbench 5 User Interface").
