...
* The email address associated with your Facebook account,Â or your telephone number
...
This section enumerates the options in theÂ CredentialsÂ andÂ DetailsÂ panes in the Facebook Ads Connector page.Â The components of the other panes in this page,Â **SchedulingÂ**andÂ **Name & Describe Your DataSet,** are universal across most connector types and are discussed in greater length inÂ [Adding a DataSet Using a Data Connector](..\adding_a_dataset_using_a_connector\index.html "Adding a DataSet Using a Data Connector").


### Credentials Pane


The Domo Facebook Ads connector uses OAuth to connect, so there is no need to enter credentials within Domo. ClickÂ **Connect**Â (or selectÂ **Add Account**Â ifÂ you haveÂ existing Facebook Ads accounts in Domo) to open the Facebook OAuth screen where you can enter your Facebook credentials. Once you have entered valid Facebook credentials, you can use the same account any time you go to create a new Facebook Ads DataSet. You can manage connector accounts in theÂ **Accounts**Â tab in theÂ Data Center. For more information about this tab, seeÂ [Managing User Accounts for Connectors](..\managing_user_accounts_for_connectors\index.html "Managing User Accounts for Connectors").


**Note:**Â If you are already logged into Facebook when you connect in Domo, you are authenticated automatically when you click **Add account**. If you want to connect to an account that is different from the one you are logged into, you must first log out of Facebook.
### Details Pane
...
| Menu | Description |
| --- | --- |
| Report | Select the Facebook Ads report you want to run.Â The following reports are available:
...
| Responder Demographics | Returns common metrics broken down by age and gender at the AdSet level. |
 ...
 |
| Ad Set | SelectÂ the ad set you want to retrieve data for. |
| Ad Account ID | Select the ID for the ad account you want to retrieve information for. |
| Ad Campaign | SelectÂ the ad campaign you want to retrieve information for. |
...
| Report Date | Specify whether theÂ report data is for a specificÂ or relative date.Â ChooseÂ **Relative** if you always want the report toÂ retrieve data for aÂ given number of days backÂ from the current date (which you specify in **Days Back**). For example, if you enter 5 for **Days Back** and set theÂ DataSet to updateÂ daily, eachÂ new day the report will update to show information for the date 5 days in the past. |
| Select Specific Date | Select the report date using the date selector. |
| Start Date | Specify whether theÂ first date in your date range is a specific or relative date. ChooseÂ **Relative** if you always want the report to retrieve data for a given number of days backÂ from the current date (which you specify inÂ **Days Back to Start From**).Â If you choose **Relative** here, you should also choose **Relative** for **End Date** and specifyÂ a value forÂ **Days Back to End At**.
For example, if you enter 10 for **Days Back to Start From** andÂ 5Â for **Days Back to End At**Â and you set theÂ DataSet to updateÂ daily, each new day the report will update to show information for 5 to 10 days in the past. |
| End Date | Specify whether theÂ last date in your date range is a specific or relative date. ChooseÂ **Relative** if you always want the report to retrieve data for a given number of days backÂ from the current date (which you specify inÂ **Days Back to End At**).Â If you choose **Relative** here, you should also choose **Relative** forÂ **Start Date** and specifyÂ a value forÂ **Days Back toÂ Start From**.
For example, if you enter 10 for **Days Back to Start From** andÂ 5Â for **Days Back to End AtÂ**and you set theÂ DataSet to updateÂ daily, each new day the report will update to show information for 5 to 10 days in the past. |
