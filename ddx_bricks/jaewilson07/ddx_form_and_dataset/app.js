...
*/
var collectionName = "jw_form_data";
...
const paint_searchContainer = (element_id, tableList, collectionService) => {
  var searchContainerEl = document.getElementById(element_id);

  var searchBox = new Search(searchContainerEl, collectionService, {
...
const paint_button = (element_id, button_label, button_fn) => {
  var buttonEl = document.getElementById(element_id);
  buttonEl.innerText = button_label;
  buttonEl.onclick = button_fn;
...
const main = async () => {
  ...
  let syncButtonEl = paint_button("syncButton", "Sync Now", () => {
  ...
  if (isShowButton) {
    ...
    exportButtonEl.style.display = "inline-block";
