...
# %% auto 0
__all__ = ['Article', 'ArticleKB_GetSoupError', 'ArticleKB_ProcessSoupError',
           'Article_KB', 'Article_Category', 'Article_KB_Home']
    ...
    def process_soup(self, soup: BeautifulSoup, debug_prn: bool = False):
        ...
        for row in table_soup:
            ...
            if child_obj:
                ...
                self.top_parent and self.top_parent.add_child_category_to_ls(
                    child_obj)
