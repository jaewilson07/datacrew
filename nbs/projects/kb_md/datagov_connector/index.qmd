...
| Drug Labeling | Returns information about drug product labeling, such as ID, indications, recommended dosage, etc.  |
...
| Workspaces | Returns a list of workspaces, including name and overview information. |
