...
5. In the **Transport Type** menu, select **OLEDB Connection Provider**.
...
13. In the **OLAP Connection** field, do one of the following:
	...
	* Build your connection string by filling in the fields in the **Connection Builder**, then click **Apply** to add the string to the **OLAP Connection** field. You can open the **Connection Builder** by clicking the arrow in the **OLAP Connection** field.  
...
17. Change the **Query Execution Timeout** value if desired.  
This is the amount of time in seconds that will elapse before a long-running job is terminated.
18. In the **Query** subtab, enter a query for the data you want to retrieve. For example:  
...
19. (Optional) Define replacement variables for columns in the DataSet in the **Replacement Variables** and **Global Replacement Variables** subtabs. For each replacement variable...
