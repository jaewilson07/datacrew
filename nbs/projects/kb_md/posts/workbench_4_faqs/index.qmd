---
title: Workbench 4 FAQs
url: https://domo-support.domo.com/s/article/360046761214
linked_kbs:  ['[https://domo-support.domo.com/s/knowledge-base/](https://domo-support.domo.com/s/knowledge-base/)', '[https://domo-support.domo.com/s/](https://domo-support.domo.com/s/)', '[https://domo-support.domo.com/s/topic/0TO5w000000ZammGAC](https://domo-support.domo.com/s/topic/0TO5w000000ZammGAC)', '[https://domo-support.domo.com/s/topic/0TO5w000000ZaoPGAS](https://domo-support.domo.com/s/topic/0TO5w000000ZaoPGAS)', '[https://domo-support.domo.com/s/topic/0TO5w000000ZapSGAS](https://domo-support.domo.com/s/topic/0TO5w000000ZapSGAS)', '[https://domo-support.domo.com/s/article/360043437373](https://domo-support.domo.com/s/article/360043437373)', '[https://domo-support.domo.com/s/article/360046765374](https://domo-support.domo.com/s/article/360046765374)', '[https://domo-support.domo.com/s/article/360047403773](https://domo-support.domo.com/s/article/360047403773)', '[https://domo-support.domo.com/s/article/360046772834](https://domo-support.domo.com/s/article/360046772834)', '[https://domo-support.domo.com/s/article/360042922874](https://domo-support.domo.com/s/article/360042922874)', '[https://domo-support.domo.com/s/article/360047494393](https://domo-support.domo.com/s/article/360047494393)', '[https://domo-support.domo.com/s/article/360046761214](https://domo-support.domo.com/s/article/360046761214)', '[https://domo-support.domo.com/s/topic/0TO5w000000ZapSGAS/workbench-4](https://domo-support.domo.com/s/topic/0TO5w000000ZapSGAS/workbench-4)', '[https://domo-support.domo.com/s/article/360043429933](https://domo-support.domo.com/s/article/360043429933)', '[https://domo-support.domo.com/s/article/360043429953](https://domo-support.domo.com/s/article/360043429953)', '[https://domo-support.domo.com/s/article/360042925494](https://domo-support.domo.com/s/article/360042925494)', '[https://domo-support.domo.com/s/article/4408174643607](https://domo-support.domo.com/s/article/4408174643607)', '[https://domo-support.domo.com/s/article/360043429913](https://domo-support.domo.com/s/article/360043429913)', '[https://domo-support.domo.com/s/login/](https://domo-support.domo.com/s/login/)']
article_id: 000004798
views: 2,207
...
![workbench_architecture.png](workbench_architecture.png)
...
Yes, both 32 and 64-bit Windows versions are supported. For more system requirements information, see [Installing Workbench 4](/s/article/360046765374 "Installing Workbench 4").
...
Workbench limits uploading to 50 million rows for a single upload job. You can use a lastvalue variable to upload rows incrementally. For more information about query parameters, see [Understanding the Workbench 4 User Interface](/s/article/360047403773 "Understanding the Workbench 4 User Interface").
...
For more information about running Workbench from the command line, see [Running Workbench 4 from the command line](/s/article/360046772834 "Running Workbench 4").
...
* The current job could be in a non-responsive state. If a job is running longer than expected, open a case with Domo Support to investigate the issue further. For information on how to contact Support, please see: [Getting Help](/s/article/360042922874).
...
![WB_jobsetup.png](WB_jobsetup.png)
...
![WB4_datasetjob.png](WB4_datasetjob.png)
...
![wb_mass_export1.png](wb_mass_export1.png) 
...
Self-serve users have a limitation of one auto-run per day and one manual run per hour. If the auto-run fails on the server, this does *not* count as your one auto-run. Auto-runs only count as runs if an execution is created (i.e. it shows up in the job history in Domo).
...
**Note:**Be sure to set notifications for failures to alert you if a job is unsuccessful. For more information, see [Setting Notifications in Workbench 4](/s/article/360047494393 "Setting Notifications in Workbench 4").
