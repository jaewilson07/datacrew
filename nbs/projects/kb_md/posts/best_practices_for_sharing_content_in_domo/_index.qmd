...
For more information about PDP, see [Personalized Data Permissions (PDP)](/s/article/360043439333 "Personalized Data Permissions (PDP)").
...
* **Social users**can only see cards shared in Buzz, in addition to Buzz conversations.
* **Participant users** have a “view only” access of content. They can...
...
* **Editor users**posses all Participant user abilities; additionally they can...
	...
	+ share cards, and
	+ create content.
* Editor users *cannot* change permissions status.
...
* **Admin users** have all access rights to content and user permissions.


For more information about access rights, see [Security Role Reference](/s/article/360043438953 "Security Role Reference").
...
For more information about groups, see [Creating and Managing User Groups](/s/article/360043438913 "Creating and Managing User Groups").
