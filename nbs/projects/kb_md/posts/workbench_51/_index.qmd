...
**Note:** To automatically account for Daylight Savings in your Workbench scheduling, select **Local time**. When the time on your machine changes for Daylight Savings, the Workbench job schedule will automatically sync with the time on your machine.
...
* The column header also provides the control to get a filtered view of protected, unprotected, or both type of entries with a single click.
	+ When you click to select the regular select view ![7.png](7.png), the Protect column will display all protected entries.
	+ When you click to select the unchecked view ![8.png](8.png), the Protect column will display the unprotected entries.
	+ When you click to select the mixed view ![9.png](9.png), the Protect column displays both protected and unprotected entries together.
...
Click on the Preview ![13.png](13.png) button in your job view.
...
You can use the bulk editor to clear a field from multiple jobs at the same time. You need to select the Edit checkbox ![36.png](36.png) and leave the field blank next to it, that you want to clear.
...
![32.png](32.png)
4. Now, the Bulk Edit wizard will display the fields that you can clear for the selected jobs. Select the Edit checkbox ![36.png](36.png) and leave the File Path field blank next to it (as we want to clear the file path that was selected while configuring the job.) and click **Continue**.  
...
![Preocessing-Edit_button.png](Preocessing-Edit_button.png)
3. You’ll be able to see a tree structure of your data.
![Query_Tables.png](Query_Tables.png)
...
![Daily_Summary_Email.png](Daily_Summary_Email.png)
...
**Note:** If you are migrating machines, make sure to turn the service OFF on the machine you are migrating from; otherwise, you will see job errors frequently. Domo recommends migrating to a clean machine.
...
**Note:** Jobs are saved in Domo, so any changes made to the jobs, after the backup, will persist.
...
![Create_backup.png](Create_backup.png)
...
![Import_backup.png](Import_backup.png)
