---
title: On-Premise SharePoint Data Provider Plugin (Beta)
url: https://domo-support.domo.com/s/article/1500008535702
linked_kbs:  ['[https://domo-support.domo.com/s/knowledge-base/](https://domo-support.domo.com/s/knowledge-base/)', '[https://domo-support.domo.com/s/](https://domo-support.domo.com/s/)', '[https://domo-support.domo.com/s/topic/0TO5w000000ZammGAC](https://domo-support.domo.com/s/topic/0TO5w000000ZammGAC)', '[https://domo-support.domo.com/s/topic/0TO5w000000ZaoPGAS](https://domo-support.domo.com/s/topic/0TO5w000000ZaoPGAS)', '[https://domo-support.domo.com/s/topic/0TO5w000000ZapUGAS](https://domo-support.domo.com/s/topic/0TO5w000000ZapUGAS)', '[https://domo-support.domo.com/s/article/1500008535702](https://domo-support.domo.com/s/article/1500008535702)', '[https://domo-support.domo.com/s/topic/0TO5w000000ZapUGAS/workbench-51](https://domo-support.domo.com/s/topic/0TO5w000000ZapUGAS/workbench-51)', '[https://domo-support.domo.com/s/article/360043429933](https://domo-support.domo.com/s/article/360043429933)', '[https://domo-support.domo.com/s/article/360043429953](https://domo-support.domo.com/s/article/360043429953)', '[https://domo-support.domo.com/s/article/360042925494](https://domo-support.domo.com/s/article/360042925494)', '[https://domo-support.domo.com/s/article/4408174643607](https://domo-support.domo.com/s/article/4408174643607)', '[https://domo-support.domo.com/s/article/360043429913](https://domo-support.domo.com/s/article/360043429913)', '[https://domo-support.domo.com/s/login/](https://domo-support.domo.com/s/login/)']
article_id: 000004877
views: 2,357
...
**Note:**Your SharePoint Plugin must be located in a subdirectory of the chosen directory.



1. In Domo Workbench, click ![1.png](1.png) in the left-hand icon bar.
2. Click **Plugins** in the **More** pane. (If you do not see this pane, click ![2.png](2.png) to expand it.)  
...
5. Click **Add** after you have chosen your DLL.
...
1. Click the ![4.png](4.png) icon in the left-hand icon bar.
2. Click the **+** button in the top right corner of the jobs listing pane.
3. An **Overview** tab for a new job will appear.
4. Enter the following details in **Job Details** section.



| **Field** | **Description** |
| --- | --- |
| Domo Domain | Select the desired account (Domo instance) in the **Domo Domain** dropdown menu.
If you have only one account set up, that account is already chosen for you and the menu is unavailable. |
| Job Name | Enter a name for the DataSet Job.
...
| Reader Type | Select the file type that you want to read from SharePoint in Workbench. |
 ...
 ![5.png](5.png)
5. In the **Domo Details** section, provide the information for your DataSet.
...
| DataSet Description | Enter a description for the DataSet, if desired.
...
**Note:** After creating a job, you cannot edit any of the settings you just configured except for the DataSet name. If you want to change any of the other settings, you must create another new job.
...
1. Provide the details for the SharePoint data in the **Source** menu.
2. Click **Edit**.
3. A **Domo SharePoint Data Provider Editor** window will appear. Here, you need to provide the Credentials and Report details required to connect to your SharePoint data.
...
| Domain | Enter your SharePoint Windows domain name.
Example: If your SharePoint site was located at [https://sample.sharepoint.com](https://sample.sharepoint.com "https://sample.sharepoint.com"), your domain name would be “sample”. |
...
1. Provide the details about data processing for the SharePoint data in the **Processing** menu.
2. Click **Edit**.
3. An **Editor** window will appear for the selected Reader type. Here, you can provide the properties and details for your data to define how your data will be handled in the DataSet.
4. Click **Apply**.
...
1. Select **Replace** if you want newly uploaded data to replace the existing data in the DataSet.
2. Select **Append** if you want the newly added data to be appended (added) to the existing data
3. Select **Partition** if you want to apply partitioning on your data. Partitioning uses a grain (like day or week) to create groups in your data. Data can then be processed as a group, and added or replaced as it changes.
4. Select the **Partition column** and **Date grain** in the respective drop downs for your data.
...
1. Select the desired transform from the drop down and click the **+** button next to it.
2. Mention the transform properties for the selected transform and click **Apply**.
3. You can add multiple transforms to your data.
4. Click ![7.png](7.png) to update the transform properties for a specific transform.
5. Click ![8.png](8.png) to remove a specific transform.
6. Click the ![9.png](9.png) (up and down arrows) to interchange the positions of the transforms.
...
**Note:** The user profile in job impersonation needs to be a role that has access to the source data needed to run the job.
...
Click the ![10.png](10.png) (**Save**) button to save your changes.
 ...
 **Warning:** Unprotected columns can be changed and deleted, which may break content in Domo.  
...
* The column header also provides the control to get a filtered view of protected, unprotected, or both type of entries with a single click.
	...
	+ When you click to select the regular select view ![14.png](14.png), the Protect column will display all protected entries.
	+ When you click to select the unchecked view ![15.png](15.png), the Protect column will display the unprotected entries.
	+ When you click to select the mixed view ![16.png](16.png), the Protect column displays both protected and unprotected entries together.
...
1. Once you are done with the job specifications, click the ![10.png](10.png) (**Save**) button to save your changes.
2. Click the ![18.png](18.png) (**Execute**) button to run your job.
